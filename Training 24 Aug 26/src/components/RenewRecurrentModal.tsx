...
export const RenewRecurrentModal: React.FC = () => {
  ...
  const [checkDate, setCheckDate] = useState<string>('2026-08-25');
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-aviation-950 border border-aviation-800 rounded-3xl p-6 shadow-2xl space-y-6 animate-fadeIn">
        {/* Header */}
        ...
        <div className="p-4 rounded-2xl bg-aviation-900/60 border border-aviation-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-aviation-800 border border-aviation-700 flex items-center justify-center font-heading font-bold text-skyline-400 text-sm">
              {renewModalInstructor.avatar_initials}
            </div>
            <div>
              <div className="text-sm font-bold text-white">{renewModalInstructor.full_name}</div>
          ...
          <div className="text-right">
            <div className="text-[10px] font-mono text-slate-400 uppercase">Base Month</div>
            <div className="text-xs font-mono font-bold text-skyline-400">{bMonth}</div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-aviation-900 border border-aviation-800 rounded-xl px-3.5 py-2.5 text-xs text-white font-mono focus:border-skyline-500 focus:outline-none"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-aviation-900 border border-aviation-800 rounded-xl px-3.5 py-2.5 text-xs text-white focus:border-skyline-500 focus:outline-none"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-3 border-t border-aviation-800">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-skyline-600 hover:from-emerald-400 hover:to-skyline-500 text-white text-xs font-semibold shadow-glow-cyan transition-all"
            >
