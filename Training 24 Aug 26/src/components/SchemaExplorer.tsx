...
EXECUTE FUNCTION enforce_dgca_fdtl_limits();`;
  ...
  return (
    <div className="space-y-6">
      <div className="p-6 rounded-2xl bg-aviation-900/80 border border-aviation-800 backdrop-blur-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <Database className="w-5 h-5 text-skyline-400" />
            <h2 className="font-heading font-bold text-xl text-white">PostgreSQL Architecture & FDTL Trigger</h2>
          </div>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-aviation-950 border border-aviation-700 hover:border-skyline-500 text-xs font-semibold text-slate-200 transition-colors"
          >
            <FileText className="w-4 h-4 text-skyline-400" />
            <span>DATABASE_SCHEMA.md</span>
          </a>
          <a
            href="/schema.sql"
            download
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-skyline-500 hover:bg-skyline-400 text-xs font-semibold text-white shadow-glow-cyan transition-all"
          >
      ...
      <div className="p-6 rounded-2xl bg-aviation-900/80 border border-aviation-800 backdrop-blur-xl space-y-4">
        ...
        <div className="p-4 rounded-xl bg-aviation-950 border border-aviation-800 font-mono text-xs text-skyline-300 overflow-x-auto leading-relaxed">
